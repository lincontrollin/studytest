...
//
//public class ElectionRecipeClient {
//	
...
//		ElectionRecipeClient server = new ElectionRecipeClient();
//		try {
//			for (int i = 0; i < CLIENT_QTY; ++i) {
//				CuratorFramework client = CuratorFrameworkFactory.newClient(server.toString(), new ExponentialBackoffRetry(1000, 3));
//				clients.add(client);
